...
public final class DFSManagedBuffer extends ManagedBuffer {
  private final FileContext hadoopFC;
  private final Path path;
  private final long offset;
  private final long length;

  public DFSManagedBuffer(Configuration hadoopConf, Path path, long length, long offset) throws IOException {
    this.hadoopFC = FileContext.getFileContext(hadoopConf);
    this.path = path;
    this.offset = offset;
    this.length = length;
  }
